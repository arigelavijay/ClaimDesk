function loadLocationData() {    
    var oTable = $('#locationTbl').dataTable({
        "bStateSave": true,
            ...
            oSettings.jqXHR = $.ajax({
                ...
                "success": function (result) {
                    ...
                    for (var key in result["loc"]) {
                        ...
                        var strlink = "<ul class='manageIcon'><li data-toggle='modal' data-target='.manage-location-modal'><img src='images/min1.png' width='16' height='19' alt='img' onclick='setLocationId(" + result["loc"][key]['id'] + ",\"show\")'></li><li><img src='images/min2.png' width='16' height='19' alt='img' onclick='setLocationId(" + result["loc"][key]['id'] + ",\"edit\")'></li><li><img src='images/min5.png' width='16' height='19' alt='img' onclick='setLocationId(" + result["loc"][key]['id'] + ",\"delete\")'></li></ul>";
...
function createLocationPageLoad(currentloc) {    
...
function setLocationId(locId, flag) {
    if (flag == 'edit') {
        $('#view').jqExLoad('views/edit-location.html', function () {
            createLocationPageLoad(locId);
        }).hide().fadeIn();
    }
    else if (flag == 'show') {
        ...
        if (response) {
            $.ajax({
                ...
                success: function (result) {                    
                    btnCreate_Onclick('views/manage-location.html');
                }
            });
        }
    }
...
function upload_loc_file(locid) {    
    //show img
    ...
    if (a) {
        ...
        document.getElementById("pr_new").style.display = "block";
        ...
        xhr.onreadystatechange = function () {            
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("pr_new").style.display = "none";
                btnCreate_Onclick('views/manage-location.html');
            }
        }
