    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            for (var key in result) {
                ...
                var str = "<ul class='manageIcon1'><li data-toggle='modal' data-target='.bs-example-modal-lg'><img src='images/min1.png' width='16' height='19' alt='img' onclick='setEmplocId(" + result[key]['id'] + ",\"show\")'></li><li><a href='#'><img src='images/min2.png' width='16' height='19' alt='img' onclick=\"setEmplocId('" + result[key]['id'] + "','edit')\"></a></li><li><a href='#'><img src='images/min5.png' width='16' height='19' alt='img' onclick=\"setEmplocId('" + result[key]['id'] + "','delete')\"></a></li></ul>";
            ...
            oSettings.jqXHR = $.ajax({
                ...
                "success": function (result) {
                    ...
                    for (var key in result["emp"]) {
                        ...
                        objinner.push(result["emp"][key]['firstName']);
                        objinner.push(result["emp"][key]['lastName']);
                        objinner.push(result["emp"][key]['empid']);
                        objinner.push(result["emp"][key]['title']);
                        objinner.push(result["emp"][key]['emailAddress']);
                        objinner.push(typeof result["emp"][key]['branchId'] != 'undefined' ? result["emp"][key]['branchId'] : '');
                        
                        var strlink = "<ul class='manageIcon1'><li data-toggle='modal' data-target='.manage-employee-modal'><img src='images/min1.png' width='16' height='19' alt='img' onclick='setEmplocId(" + result["emp"][key]['id'] + ",\"show\")'></li><li><a href='#'><img src='images/min2.png' width='16' height='19' alt='img' onclick=\"setEmplocId('" + result["emp"][key]['id'] + "','edit')\"></a></li><li><a href='#'><img src='images/min5.png' width='16' height='19' alt='img' onclick=\"setEmplocId('" + result["emp"][key]['id'] + "','delete')\"></a></li></ul>";
...
function createEmpPageLoad(currentemp) {    
    if (currentemp) {
        $.ajax({
            type: "GET",
            contentType: "application/json;charset=utf-8",
            ...
            success: function (result) {               
                ...
                $("#dob").val(appendTimeNConvLoc(result['dob']));
                ...
                $("#hiredate").val(appendTimeNConvLoc(result['hiredate']));
                $("#terminatedate").val(appendTimeNConvLoc(result['terminatedate']));
...
function setEmplocId(locId, flag) {
    if (flag == 'show') {        
        $.ajax({
            type: "GET",
            contentType: "application/json;charset=utf-8",
            ...
            success: function (result) {
                ...
                $("#dob").html(appendTimeNConvLoc(checkdate(result['dob'])));
                ...
                $("#hiredate").html(appendTimeNConvLoc(checkdate(result['hiredate'])));
                $("#terminatedate").html(appendTimeNConvLoc(checkdate(result['terminatedate'])));
        ...
        $('#view').jqExLoad('views/edit-employee.html', function () {
            createEmpPageLoad(locId);
        }).hide().fadeIn();
    }
    else if (flag == 'delete') {
        ...
        if (response) {
            $.ajax({
                ...
                success: function (result) {
                    btnCreate_Onclick('views/manage-employee.html');
                }
            });
        }
    }
...
function save_employee() {
    ...
    if ($("#frmempl").valid()) {
        ...
        var jsonData = {
            ...
            "gender": $("#gender").val(),
            "dob": getDate(localToUtc($("#dob").val())),
            ...
            "hiredate": getDate(localToUtc($("#hiredate").val())),
            "terminatedate": getDate(localToUtc($("#terminatedate").val())),
            "wage": $("#wage").val(),
